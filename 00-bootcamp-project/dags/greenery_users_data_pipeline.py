...
def _load_data_to_gcs(ds):
    # YOUR CODE HERE
    keyfile_gcs = f"{DAGS_FOLDER}/deb2-loading-files-to-gcs395109-b2ef1e3212c3.json"
...
def _load_data_from_gcs_to_bigquery(ds, **context):
    # YOUR CODE HERE
    keyfile_bigquery = f"{DAGS_FOLDER}/deb2-gcs-to-bigquery.json"
